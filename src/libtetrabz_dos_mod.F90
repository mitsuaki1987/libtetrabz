...
! Compute DOS
!
SUBROUTINE libtetrabz_dos(ltetra,comm0,bvec,nb,nge,eig,ngw,wght0,ne,e0) BIND(C)
  !
#if defined(__MPI)
...
SUBROUTINE libtetrabz_dos_main(eig,e0,dos)
  ...
  REAL(8) :: e(4), V, w1(ne,4), w2(3), ei1(4,nb), tsmall(3,4)
  !
  dos(1:ne, 1:nb, 1:nk_local) = 0d0
  w2(1:3) = 1d0 / 3d0
  !
  !$OMP PARALLEL DEFAULT(NONE) &
  !$OMP & SHARED(nt_local,nb,ne,ik_global,ik_local,wlsm,eig,w2,e0,dos) &
  !$OMP & PRIVATE(ib,it,ie,e,w1,ei1,V,indx)
  !
  DO it = 1, nt_local
     !
     DO ib = 1, nb
