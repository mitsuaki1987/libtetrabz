module libtetra_common
  ...
  interface
     !
     subroutine libtetra_initialize()
     end subroutine libtetra_initialize
     !
     subroutine libtetra_occ(eig,occ)
       import nb, nk, nk0
       real(8),intent(in) :: eig(nb,nk)
       real(8),intent(out) :: occ(nb,nk0)
     end subroutine libtetra_occ
     !
     subroutine libtetra_sort(n1,n2,a)
       integer,intent(in) :: n1, n2
       real(8),intent(inout) :: a(n1,n2) 
     end subroutine libtetra_sort
     !
     subroutine libtetra_dos(eig,e0,dos)
       import nb, nk, nk0, ne
       real(8),intent(in) :: eig(nb,nk), e0(ne)
       real(8),intent(out) :: dos(ne,nb,nk0)
     end subroutine libtetra_dos
     !
     subroutine libtetra_doubledelta(eig1,eig2,ddel)
       import nb, nk, nk0
       real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk)
       real(8),intent(out) :: ddel(nb,nb,nk0)
     end subroutine libtetra_doubledelta
     !
     subroutine libtetra_doubledelta2(ej,w)
       import nb
       real(8),intent(in) :: ej(nb,3)
       real(8),intent(inout) :: w(4,nb,3)
     end subroutine libtetra_doubledelta2
     !
     subroutine libtetra_occstep(eig1,eig2,ocst)
       import nb, nk, nk0
       real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk)
       real(8),intent(out) :: ocst(nb,nb,nk0)
     end subroutine libtetra_occstep
     !
     subroutine libtetra_occstep2(de,w)
       import nb
       real(8),intent(in) :: de(nb,4)
       real(8),intent(inout) :: w(4,nb,4)
     end subroutine libtetra_occstep2
     !
     subroutine libtetra_polstat(eig1,eig2,pols)
       import nb, nk, nk0
       real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk)
       real(8),intent(out) :: pols(nb,nb,nk0)
     end subroutine libtetra_polstat
     !
     subroutine libtetra_polstat2(ei,ej,w)
       import nb
       real(8),intent(in) :: ei(4), ej(nb,4)
       real(8),intent(inout) :: w(4,nb,4)
     end subroutine libtetra_polstat2
     !
     subroutine libtetra_polstat3(ei,ej,w)
       real(8),intent(in) :: ei(4), ej(4)
       real(8),intent(inout) :: w(4,4)
     end subroutine libtetra_polstat3
     !
     function libtetra_polstat_1234(g1,g2,g3,g4,lng1,lng2,lng3,lng4) result(w)
       real(8),intent(in) :: g1,g2,g3,g4,lng1,lng2,lng3,lng4
       real(8) :: w
     end function libtetra_polstat_1234
     !
     function libtetra_polstat_1231(g1,g2,g3,lng1,lng2,lng3) result(w)
       real(8),intent(in) :: g1,g2,g3,lng1,lng2,lng3
       real(8) :: w
     end function libtetra_polstat_1231
     !
     function libtetra_polstat_1233(g1,g2,g3,lng1,lng2,lng3) result(w)
       real(8),intent(in) :: g1,g2,g3,lng1,lng2,lng3
       real(8) :: w
     end function libtetra_polstat_1233
     !
     function libtetra_polstat_1221(g1,g2,lng1,lng2) result(w)
       real(8),intent(in) :: g1,g2,lng1,lng2
       real(8) :: w
     end function libtetra_polstat_1221
     !
     function libtetra_polstat_1211(g1,g2,lng1,lng2) result(w)
       real(8),intent(in) :: g1,g2,lng1,lng2
       real(8) :: w
     end function libtetra_polstat_1211
     !
     function libtetra_polstat_1222(g1,g2,lng1,lng2) result(w)
       real(8),intent(in) :: g1,g2,lng1,lng2
       real(8) :: w
     end function libtetra_polstat_1222
     !
     subroutine libtetra_fermigr(eig1,eig2,e0,fgr)
       import nb, nk, nk0, ne
       real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk), e0(ne)
       real(8),intent(out) :: fgr(ne,nb,nb,nk0)
     end subroutine libtetra_fermigr
     !
     subroutine libtetra_fermigr2(e0,ei,ej,w)
       import nb, ne
       real(8),intent(in) :: e0(ne), ei(4), ej(nb,4)
       real(8),intent(inout) :: w(4,ne,nb,4)
     end subroutine libtetra_fermigr2
     !
     subroutine libtetra_fermigr3(e0,de,w)
       import ne
       real(8),intent(in) :: e0(ne), de(4)
       real(8),intent(inout) :: w(4,ne,4)
     end subroutine libtetra_fermigr3
     !
     subroutine libtetra_polimg(eig1,eig2,e0,poli)
       import nb, nk, nk0, ne
       real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk), e0(ne)
       real(8),intent(out) :: poli(2,ne,nb,nb,nk0)
     end subroutine libtetra_polimg
     !
     subroutine libtetra_polimg2(e0,ei,ej,w)
       import nb, ne
       real(8),intent(in) :: e0(ne), ei(4), ej(nb,4)
       real(8),intent(inout) :: w(4,2,ne,nb,4)
     end subroutine libtetra_polimg2
     !
     subroutine libtetra_polimg3(e0,de,w)
       import ne
       real(8),intent(in) :: e0(ne), de(4)
       real(8),intent(inout) :: w(4,2,ne,4)
     end subroutine libtetra_polimg3
     !
     function libtetra_polimg_1234(g1,g2,g3,g4) result(w)
       real(8),intent(in) :: g1,g2,g3,g4
       real(8) :: w(2)
     end function libtetra_polimg_1234
     !
     function libtetra_polimg_1231(g1,g2,g3) result(w)
       real(8),intent(in) :: g1,g2,g3
       real(8) :: w(2)
     end function libtetra_polimg_1231
     !
     function libtetra_polimg_1233(g1,g2,g3) result(w)
       real(8),intent(in) :: g1,g2,g3
       real(8) :: w(2)
     end function libtetra_polimg_1233
     !
     function libtetra_polimg_1221(g1,g2) result(w)
       real(8),intent(in) :: g1,g2
       real(8) :: w(2)
     end function libtetra_polimg_1221
     !
     function libtetra_polimg_1211(g1,g2) result(w)
       real(8),intent(in) :: g1, g2
       real(8) :: w(2)
     end function libtetra_polimg_1211
     !
     function libtetra_polimg_1222(g1,g2) result(w)
       real(8),intent(in) :: g1, g2
       real(8) :: w(2)
     end function libtetra_polimg_1222
     !
     ...
     end subroutine libtetra_interpol_weight
     !
  ...
  !
end module libtetra_common
!
! define shortest diagonal line & define type of tetragonal
!
subroutine libtetra_initialize()
  !
  use libtetra_common, only : ltetra, ng, bvec, wlsm, ivvec, nt, nk, ng
  implicit none
  !
  ...
  if(ltetra == 1) then
     !
     write(*,*) "[libtetra] Linear tetrahedron method is used."
     !
     wlsm(1:4,1:20) = 0.0d0
     wlsm(1,1) = 1.0d0
     wlsm(2,2) = 1.0d0
     ...
     !
     write(*,*) "[libtetra] Improved tetrahedron method is used."
     !
     ...
     !
     write(*,*) "[libtetra] STOP! ltetrta is invalid."
     stop
     !
  end if
  !
...
subroutine libtetra_occ(eig,occ)
  !
  use libtetra_common, only : nb, nk, nk0, fst, lst, wlsm, indx1, indx2, ef, libtetra_sort
  implicit none
  !
  real(8),intent(in) :: eig(nb,nk)
  real(8),intent(out) :: occ(nb,nk0)
...
subroutine libtetra_dos(eig,e0,dos)
  !
  use libtetra_common, only : nb, nk, nk0, ne, fst, lst, wlsm, indx1, indx2, libtetra_sort
  implicit none
  !
  real(8),intent(in) :: eig(nb,nk), e0(ne)
  real(8),intent(out) :: dos(ne,nb,nk0)
...
subroutine libtetra_doubledelta(eig1,eig2,ddel)
  !
  use libtetra_common, only : nb, nk, nk0, fst, lst, indx1, indx2, wlsm, &
  &                    libtetra_sort, libtetra_doubledelta2
  implicit none
  !
  real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk)
  real(8),intent(out) :: ddel(nb,nb,nk0)
  ...
  do it = fst, lst
     ...
     do ib = 1, nb
        ...
        if(e(1) < 0d0 .and. 0d0 <= e(2)) then
           ...
           !
           call libtetra_doubledelta2(ej2,w2)
           !
...
subroutine libtetra_doubledelta2(ej,w)
  !
  use libtetra_common, only : nb, libtetra_sort
  implicit none
  !
  real(8),intent(in) :: ej(nb,3)
  real(8),intent(inout) :: w(4,nb,3)
...
subroutine libtetra_occstep(eig1,eig2,ocst)
  !
  use libtetra_common, ONLY : nb, nk, nk0, fst, lst, indx1, indx2, wlsm, &
  &                           libtetra_sort, libtetra_occstep2
  implicit none
  !
  real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk)
...
subroutine libtetra_polstat(eig1,eig2,pols)
  !
  use libtetra_common, ONLY : nk, nk0, nb, fst, lst, indx1, indx2, wlsm, &
  &                           libtetra_sort, libtetra_polstat2
  implicit none
  !
  real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk)
  real(8),intent(out) :: pols(nb,nb,nk0)
     ...
     do ib = 1, nb
        ...
        if( e(1) <= 0d0 .and. 0d0 < e(2) ) then
           ...
           if(V > thr) then
              ...
              ! 
              call libtetra_polstat2(ei2,ej2,w2)
              !
              w1(1:4,1:nb) = w1(1:4,1:nb) + V * sum(w2(1:4,1:nb,1:4), 3)
              !
           end if
...
subroutine libtetra_polstat2(ei,ej,w)
  !
  use libtetra_common, ONLY : nb, libtetra_sort, libtetra_polstat3
  !
  implicit none
  !
  real(8),intent(in) :: ei(4), ej(nb,4)
  ...
  do ib = 1, nb
     ...
     if((e(1) <= 0d0 .and. 0d0 < e(2)) .or. (e(1) < 0d0 .and. 0d0 <= e(2))) then
        ...
        if(V > thr) then
           ...
           !
           call libtetra_polstat3(ei2,ej2,w2)
           !
           w(1:4, ib,1:4) = w(1:4, ib, 1:4) + w2(1:4, 1:4) * V
           !
        end if
...
subroutine libtetra_polstat3(ei,ej,w)
  !
  use libtetra_common, ONLY : libtetra_sort, &
  &   libtetra_polstat_1234, libtetra_polstat_1231, libtetra_polstat_1233, &
  &   libtetra_polstat_1221, libtetra_polstat_1222, libtetra_polstat_1211
  !
  implicit none
  !
  real(8),intent(in) :: ei(4), ej(4)
  ...
  if(abs(de(4) - de(3)) < thr ) then
     if(abs(de(4) - de(2)) < thr ) then
        if(abs(de(4) - de(1)) < thr ) then
           ...
           ! de(4) = de(3) = de(2)
           !
           w2(4) = libtetra_polstat_1211(de(4),de(1),lnd(4),lnd(1))
           w2(3) = w2(4)
           w2(2) = w2(4)
           w2(1) = libtetra_polstat_1222(de(1),de(4),lnd(1),lnd(4))
           !
        ...
        ! de(4) = de(3), de(2) = de(1)
        !
        w2(4) = libtetra_polstat_1221(de(4),de(2), lnd(4),lnd(2))
        w2(3) = w2(4)
        w2(2) = libtetra_polstat_1221(de(2),de(4), lnd(2),lnd(4))
        w2(1) = w2(2)
        !
        if(any(w2(1:4) < 0d0)) then
           write(*,'(100e15.5)') de(1:4)
        ...
        ! de(4) = de(3)
        !
        w2(4) = libtetra_polstat_1231(de(4),de(1),de(2),lnd(4),lnd(1),lnd(2))
        w2(3) = w2(4)
        w2(2) = libtetra_polstat_1233(de(2),de(1),de(4),lnd(2),lnd(1),lnd(4))
        w2(1) = libtetra_polstat_1233(de(1),de(2),de(4),lnd(1),lnd(2),lnd(4))
        !
        if(any(w2(1:4) < 0d0)) then
           write(*,'(100e15.5)') de(1:4)
           write(*,'(100e15.5)') w2(1:4)
     ...
     if(abs(de(3) - de(1)) < thr) then
        ...
        ! de(3) = de(2) = de(1)
        !
        w2(4) = libtetra_polstat_1222(de(4),de(3), lnd(4),lnd(3))
        w2(3) = libtetra_polstat_1211(de(3),de(4), lnd(3),lnd(4))
        w2(2) = w2(3)
        w2(1) = w2(3)
        !
        if(any(w2(1:4) < 0d0)) then
        ...
        ! de(3) = de(2)
        !
        w2(4) = libtetra_polstat_1233(de(4),de(1),de(3),lnd(4),lnd(1),lnd(3))
        w2(3) = libtetra_polstat_1231(de(3),de(1),de(4),lnd(3),lnd(1),lnd(4))
        w2(2) = w2(3)
        w2(1) = libtetra_polstat_1233(de(1),de(4),de(3),lnd(1),lnd(4),lnd(3))
        !
        if(any(w2(1:4) < 0d0)) then
           write(*,'(100e15.5)') de(1:4)
           write(*,'(100e15.5)') w2(1:4)
     ...
     ! de(2) = de(1)
     !
     w2(4) = libtetra_polstat_1233(de(4),de(3),de(2),lnd(4),lnd(3),lnd(2))
     w2(3) = libtetra_polstat_1233(de(3),de(4),de(2),lnd(3),lnd(4),lnd(2))
     w2(2) = libtetra_polstat_1231(de(2),de(3),de(4),lnd(2),lnd(3),lnd(4))
     w2(1) = w2(2)
     !
     if(any(w2(1:4) < 0d0)) then
        write(*,'(100e15.5)') de(1:4)
     ...
     !
     w2(4) = libtetra_polstat_1234(de(4),de(1),de(2),de(3),lnd(4),lnd(1),lnd(2),lnd(3))
     w2(3) = libtetra_polstat_1234(de(3),de(1),de(2),de(4),lnd(3),lnd(1),lnd(2),lnd(4))
     w2(2) = libtetra_polstat_1234(de(2),de(1),de(3),de(4),lnd(2),lnd(1),lnd(3),lnd(4))
     w2(1) = libtetra_polstat_1234(de(1),de(2),de(3),de(4),lnd(1),lnd(2),lnd(3),lnd(4))
     !
     if(any(w2(1:4) < 0d0)) then
        write(*,'(100e15.5)') de(1:4)
        write(*,'(100e15.5)') w2(1:4)
...
subroutine libtetra_fermigr(eig1,eig2,e0,fgr)
  !
  use libtetra_common, ONLY : nb, nk, nk0, ne, fst, lst, indx1, indx2, wlsm, &
  &                           libtetra_sort, libtetra_fermigr2
  implicit none
  !
  real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk), e0(ne)
  real(8),intent(out) :: fgr(ne,nb,nb,nk0)
     ...
     do ib = 1, nb
        ...
        if( e(1) <= 0d0 .and. 0d0 < e(2) ) then
           ...
           if(V > thr) then
              ...
              &                                  (/4, ne, nb, 4/))
              !
              call libtetra_fermigr2(e0,ei2,ej2,w2)
              !
...
subroutine libtetra_fermigr2(e0,ei,ej,w)
  !
  use libtetra_common, ONLY : nb, ne, libtetra_sort, libtetra_fermigr3
  !
  implicit none
  !
  real(8),intent(in) :: e0(ne), ei(4), ej(nb,4)
  ...
  do ib = 1, nb
     ...
     tmp(2:1 + 4 * ne,1:4) = reshape(w(1:4,1:ne,ib,1:4), (/4 * ne, 4/))
     call libtetra_sort(nn, 4, tmp)
     e(1:4) = tmp(1,1:4)
     ...
     if((e(1) <= 0d0 .and. 0d0 < e(2)) .or. (e(1) < 0d0 .and. 0d0 <= e(2))) then
        ...
        if(V > thr) then
           ...
           !
           de(1:4) = tmp2(1,1:4)
           w2(1:4,1:ne,1:4) = reshape(tmp(2:1 + 4 * ne,1:4), (/4, ne, 4/))
           !
           call libtetra_fermigr3(e0,de,w2)
           !
...
subroutine libtetra_fermigr3(e0,de,w)
  !
  use libtetra_common, only : ne, libtetra_sort
  implicit none
  !
  real(8),intent(in) :: e0(ne), de(4)
  real(8),intent(inout) :: w(4,ne,4)
...
subroutine libtetra_polimg(eig1,eig2,e0,poli)
  !
  use libtetra_common, ONLY : nb, nk, nk0, ne, fst, lst, indx1, indx2, wlsm, &
  &                           libtetra_sort, libtetra_polimg2
  implicit none
  !
  real(8),intent(in) :: eig1(nb,nk), eig2(nb,nk), e0(ne)
  real(8),intent(out) :: poli(2,ne,nb,nb,nk0)
     ...
     do ib = 1, nb
        ...
        if( e(1) <= 0d0 .and. 0d0 < e(2) ) then
           ...
           if(V > thr) then
              ...
              &                                  (/4, 2, ne, nb, 4/))
              !
              call libtetra_polimg2(e0,ei2,ej2,w2)
              !
...
subroutine libtetra_polimg2(e0,ei,ej,w)
  !
  use libtetra_common, ONLY : nb, ne, libtetra_sort, libtetra_polimg3
  !
  implicit none
  !
  real(8),intent(in) :: e0(ne), ei(4), ej(nb,4)
  ...
  do ib = 1, nb
     ...
     if((e(1) <= 0d0 .and. 0d0 < e(2)) .or. (e(1) < 0d0 .and. 0d0 <= e(2))) then
        ...
        if(V > thr) then
           ...
           !
           de(1:4) = tmp2(1,1:4)
           w2(1:4,1:2,1:ne,1:4) = reshape(tmp(2:1 + 8 * ne,1:4), (/4, 2, ne, 4/))
           !
           call libtetra_polimg3(e0,de,w2)
           !
...
subroutine libtetra_polimg3(e0,de,w)
  !
  use libtetra_common, ONLY : ne, libtetra_sort, &
  &   libtetra_polimg_1234, libtetra_polimg_1231, libtetra_polimg_1233, &
  &   libtetra_polimg_1221, libtetra_polimg_1222, libtetra_polimg_1211
  !
  implicit none
  !
  real(8),intent(in) :: e0(ne), de(4)
  ...
  call libtetra_sort(1 + 8 * ne, 4, tmp)
     ...
     if(abs(e(4) - e(3)) < thr ) then
        if(abs(e(4) - e(2)) < thr ) then
           if(abs(e(4) - e(1)) < thr ) then
              ...
              ! e(4) = e(3) = e(2)
              !
              w2(1:2,4) = libtetra_polimg_1211(e(4),e(1))
              w2(1:2,3) = w2(1:2,4)
              w2(1:2,2) = w2(1:2,4)
              w2(1:2,1) = libtetra_polimg_1222(e(1),e(4))
              !
           ...
           ! e(4) = e(3), e(2) = e(1)
           !
           w2(1:2,4) = libtetra_polimg_1221(e(4),e(2))
           w2(1:2,3) = w2(1:2,4)
           w2(1:2,2) = libtetra_polimg_1221(e(2),e(4))
           w2(1:2,1) = w2(1:2,2)
           !
           if(any(w2(1:2,1:4) < 0d0)) then
              write(*,*) ie
           ...
           ! e(4) = e(3)
           !
           w2(1:2,4) = libtetra_polimg_1231(e(4),e(1),e(2))
           w2(1:2,3) = w2(1:2,4)
           w2(1:2,2) = libtetra_polimg_1233(e(2),e(1),e(4))
           w2(1:2,1) = libtetra_polimg_1233(e(1),e(2),e(4))
           !
           if(any(w2(1:2,1:4) < 0d0)) then
              write(*,*) ie
              write(*,'(100e15.5)') e(1:4)
        ...
        if(abs(e(3) - e(1)) < thr) then
           ...
           ! e(3) = e(2) = e(1)
           !
           w2(1:2,4) = libtetra_polimg_1222(e(4),e(3))
           w2(1:2,3) = libtetra_polimg_1211(e(3),e(4))
           w2(1:2,2) = w2(1:2,3)
           w2(1:2,1) = w2(1:2,3)
           !
           if(any(w2(1:2,1:4) < 0d0)) then
           ...
           ! e(3) = e(2)
           !
           w2(1:2,4) = libtetra_polimg_1233(e(4),e(1),e(3))
           w2(1:2,3) = libtetra_polimg_1231(e(3),e(1),e(4))
           w2(1:2,2) = w2(1:2,3)
           w2(1:2,1) = libtetra_polimg_1233(e(1),e(4),e(3))
           !
           if(any(w2(1:2,1:4) < 0d0)) then
              write(*,*) ie
              write(*,'(100e15.5)') e(1:4)
        ...
        ! e(2) = e(1)
        !
        w2(1:2,4) = libtetra_polimg_1233(e(4),e(3),e(2))
        w2(1:2,3) = libtetra_polimg_1233(e(3),e(4),e(2))
        w2(1:2,2) = libtetra_polimg_1231(e(2),e(3),e(4))
        w2(1:2,1) = w2(1:2,2)
        !
        if(any(w2(1:2,1:4) < 0d0)) then
           write(*,*) ie
        ...
        ! Different each other.
        !
        w2(1:2,4) = libtetra_polimg_1234(e(4),e(1),e(2),e(3))
        w2(1:2,3) = libtetra_polimg_1234(e(3),e(1),e(2),e(4))
        w2(1:2,2) = libtetra_polimg_1234(e(2),e(1),e(3),e(4))
        w2(1:2,1) = libtetra_polimg_1234(e(1),e(2),e(3),e(4))
        !
        if(any(w2(1:2,1:4) < 0d0)) then
           write(*,*) ie
           write(*,'(100e15.5)') e(1:4)
...
subroutine libtetra_interpol_weight(nb,ngc,ngd,wc,wd)
  ...
  !$OMP DO REDUCTION(+: wc)
  do ik = 1, nk0
     call libtetra_interpol_weight2(nkc, nb, ngc, kv(1:3,indx3(ik)), wd(1:nb,ik), wc)
  end do
  !$OMP END DO
  !$OMP END PARALLEL
  !
